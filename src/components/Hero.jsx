...
function Hero() {
  return (
    ...
    <img src="https://media.licdn.com/dms/image/D4D03AQH9V3rRkGSIiA/profile-displayphoto-shrink_200_200/0/1687114916636?e=2147483647&v=beta&t=2rnle68ci6iV-4TewFypHy49uUsRKFrxJdi0OswX_d0" className="rounded-md float-right "/>
        <div>
            <p className="flex items-center text-indigo-800"><span className="block w-10 h-px bg-indigo-800 align-middle mr-1 "></span> Orhan Kalsın</p>
      <h1 className=" text-7xl leading-none font-bold">Creative thinker Minimalism lover</h1>
      <p className="ttext-lg leading-7 font-normal w-3/4">Hi, I’m Orhan. I’m a full-stack developer. If you are looking for a Developer who to craft solid and scalable frontend products with great user experiences. Let’s shake hands with me.</p>
